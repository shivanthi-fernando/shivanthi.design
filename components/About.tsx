  ...
  return (
    <section className={compact ? "pb-20 pt-4 sm:pb-28 sm:pt-6" : "pb-20 pt-10 sm:pb-28 sm:pt-14 md:pt-16"}>
      <div className="mx-auto max-w-5xl px-6 sm:px-12 lg:px-20">
        ...
        <div className="mt-4 flex flex-col-reverse gap-10 lg:flex-row lg:items-center lg:justify-between lg:gap-12">
          {/* Narrative intro */}
          <div className="max-w-2xl">
            ...
            {compact && (
              <Reveal delay={140} className="mt-7">
                <ButtonUnderline href="/about">More about me</ButtonUnderline>
              </Reveal>
            )}
          </div>

          {/* Photo — same white polaroid frame as the gallery below */}
          <Reveal delay={40} className="shrink-0 self-center lg:-mt-6">
