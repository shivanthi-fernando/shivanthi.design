 ...
 * that folder and it shows up here too, no code changes needed.
 */
export default async function DesignShots() {
  ...
  return (
    <div className="mt-16">
      <h3 className="font-display text-xl font-semibold text-ink">Design Shots</h3>
      <p className="mt-1.5 max-w-2xl text-lg leading-relaxed text-muted">
        A collection of interface designs and explorations from different projects.
      </p>
